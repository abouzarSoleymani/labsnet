...
export const News = () => {
  const news = [
    ...
    },
    {
      ...
      date: '۱۵ بهمن ۱۴۰۲',
      title:
        'کارشناسان برتر- تجربه و توانمندی کارشناسان، ستون اصلی پژوهش‌های کارآمد است',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      date: '۱۴ بهمن ۱۴۰۲',
      title:
        'عرضه خدمات آزمایشگاهی کارآمد در حوزه «غذا»، «محیط زیست» و «کشاورزی»',
    },
    {
      id: 5,
      ...
      date: '۱۲ بهمن ۱۴۰۲',
      title:
        'تصویب ۱۶۵مین استاندارد ملی فناوری نانو با عنوان « فناوری نانو - نانولوله‌های کربنی چنددیواره - تعیین میزان ناخالصی کربن با آنالیز گرماوزن سنجی »',
    },
    {
      id: 6,
      ...
      date: '۱۲ بهمن ۱۴۰۲',
      title:
        'برگزاری کارگاه آموزشی قائده تصمیم‌گیری و بیانیه انطباق بر مبنای استاندارد 17025',
    },
    {
      id: 7,
    ...
    },
    {
      ...
      date: '۱۱ بهمن ۱۴۰۲',
      title:
        'دانشگاه تبریز: تولید نانوسامانه جدید دارورسانی برای درمان موثرتر سرطان',
    },
  ];
  return (
